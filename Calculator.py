...
if ans==2:
        ...
        εκθετης=float(input("Εισαγετε τον εκθετη"))
        result4=βαση**εκθετης
        num3=float(input("Εισαγετε τον πρωτο αριθμο "))
        num4=float(input("Εισαγετε τον δευτερο αριθμο"))
        result5=num3//num4
        print("Προσθεση")
        print(result)
        print("Πολλαπλασιασμος")
        print (result2)
        print("Αφαιρεση")
        print(result3)
        print ("Υψωση σε δυναμη")
        print (result4)
        print("Διαιρεση")
        print (result5)
